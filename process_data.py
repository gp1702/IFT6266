...
class inital_process(object):


    def __init__(self, root_path="inpainting", img_path = 'train2014',
                 caps_path='dict_key_imgID_value_caps_train_and_valid.pkl',
                 batch_size=128, nb_sub=None, extract_center=True, load_caption=False, process_text=True, isCallFromPreprocess=False):
    ...
    def _load_caps(self):
        ...
        self.vocab, self.mapping = utils.get_vocab(self.caption_dict, remove_stop_words=False)
    ...
    def process_captions(self):
            self.processed_data = utils.filter_caps(self.caption_dict, self.mapping, switch=self.switch) #Changed
